...
class Parser():
    def __init__(self):
        self.items = ['department', 'dept_code', 'serial', 'code', 'class_code',
        ...
        self.depts = ['A2', 'A3', 'A4', 'A5', 'A6', 'AA', 'AH', 'AN', 'C0', 'XZ', 'A1',
    ...
    def __to_word(self, n):
        return {1: '1', 2: '2', 3: '3', 4: '4', 5: 'N',
                ...
                11: 'A', 12: 'B', 13: 'C', 14: 'D'}[n]

    def __to_time(self, s):
        return {'0': 1, '1': 1, '2': 2, '3': 3, '4': 4, 'N': 5,
                '5': 6, '6': 7, '7': 8, '8': 9, '9': 10,
                'A': 11, 'B': 12, 'C': 13, 'D': 14}[s]

    def __normalize(self, raw_time):
        ...
        for time in times:
            ...
            start = self.__to_time(raw[0][-1])
            end = self.__to_time(raw[1]) if len(raw) > 1 else self.__to_time(raw[0][-1])
            for i in range(start, end + 1):
                result += self.__to_word(i)
